...
<script src="${ctx}/js/repair/badMaterialDetailList.js"></script>
        ...
        <td  style="background-color:white;" height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="94%" align="center"><span>我的申请</span></td>
              </tr>
            </table></td>
            <%-- <td><div align="right">
              <span>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="5%" height="15" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">器材编号</span></div></td>
        <td width="20%" height="25" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">损坏说明</span></div></td>
        <td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">损坏时间</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">基本操作</span></div></td>
      </tr>
      <c:forEach var="materialDetail" items="${pageBean.rowDatas}">
	      <tr  id="${materialDetail.id}" class="badDetailListTr">
			<td height="20" bgcolor="#FFFFFF" class="STYLE19"<div align="center">${materialDetail.material.materialName}</div></td>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"<div align="center">${materialDetail.materialCode}</div></td>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"<div align="center">${materialDetail.badContext}</div></td>
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"<div align="center">${materialDetail.modifyTime}</div></td>
	        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a id="resultBtn" href="#">已经维修</a></div></td>
	      </tr>
      </c:forEach>
    </table></td>
  </tr>
