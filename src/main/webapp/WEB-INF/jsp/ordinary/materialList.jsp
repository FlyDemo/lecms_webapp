...
<script src="${ctx}/js/ordinary/materialList.js"></script>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <td  style="background-color:white;" height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="94%" align="center"><span>器材查看</span></td>
              </tr>
            </table></td>
           <%--  <td><div align="right">
              <span>
  ...
  <tr>
  	<input type="hidden" id="categoryId" name="categoryId" value="${materialCategory.id}"
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      ...
      <c:forEach var="materialBean" items="${pageBean.rowDatas}">
	      <tr  id="${materialBean.id}" class="materialListTr">
	        ...
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div id="surPlus" align="center">${materialBean.surPlus}</div></td>
	        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a id="viewBtn" href="#">查看</a> | <a id="borrowBtn" href="#"> 申请借出  </a></div></td>
	      </tr>
      </c:forEach>
    </table></td>
  </tr>
