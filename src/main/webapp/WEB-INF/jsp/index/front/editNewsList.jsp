...
<script src="${ctx}/js/index/front/editNewsList.js"></script>
        ...
        <td  style="background-color:white;" height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="94%" align="center"><span>消息列表信息 </span></td>
              </tr>
            </table></td>
            <td><div align="right">
              <span>
	              <img src="${ctx}/images/add.gif" width="10" height="10" /> <a href="${ctx}/WorkController/editNewsPage?op=edit" style="text-decoration:none;">添加</a>  &nbsp;&nbsp;&nbsp;
              </span></div></td>
          </tr>
        </table></td>
      </tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">新闻时间</span></div></td>
        <td width="27%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">创建时间</span></div></td>
        <td width="16%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">创建人</span></div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">是否置顶显示</span></div></td>
      ...
      <c:forEach var="newsBean" items="${pageBean.rowDatas}">
	      <tr  id="${newsBean.id}" class="newsDataListTr">
	        ...
	        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${newsBean.topShow == true?"是":"否"}</div></td>
	        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="${ctx}/WorkController/editNewsPage?id=${newsBean.id}&op=view">查看</a> |<a href="${ctx}/WorkController/editNewsPage?id=${newsBean.id}&op=edit"> 编辑</a>|<a id="deleteBtn" href="#"> 删除</a></div></td>
	      </tr>
      </c:forEach>
    </table></td>
  </tr>
