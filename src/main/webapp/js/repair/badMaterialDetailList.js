$("document").ready(function(){
	...
	listPageData("/lecms_webapp/WorkController/badMaterialDetailList");
	
	$("tr").find("a#resultBtn").on("click",function(){
		var id = $(this).parents("tr.badDetailListTr").attr("id");
		$(location).attr("href","/lecms_webapp/WorkController/repairMaterial?id="+id);
	});
